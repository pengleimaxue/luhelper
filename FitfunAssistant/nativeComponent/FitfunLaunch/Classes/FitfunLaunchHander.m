...
SINGLETON_FOR_IMPLEMENTATION(FitfunLaunchHander)

+ (void)launchAppSuccess:(dispatch_block_t)successBlock  {
    [[FitfunLaunchHander sharedFitfunLaunchHander] launchAppSuccess:successBlock];
}
...
- (void)managerCallAPIDidSuccess:(CTAPIBaseManager *)manager {
    ...
    if (resultDict == nil) {
        [PLAlertView showAlertWithTitle:@"友情提示"
                                message:@"初始化失败"
                          isAutoDismiss:YES
